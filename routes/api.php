...
use App\Http\Controllers\Api\Central\PackageController;
use App\Http\Controllers\Api\Central\PageController;
...
Route::get('pages', [PageController::class, 'index'])->name('central.pages.index');
Route::get('pages/{slug}', [PageController::class, 'show'])->name('central.pages.show');
