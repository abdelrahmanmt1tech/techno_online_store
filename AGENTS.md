...
| [`docs/messenger-messaging-module.md`](messenger-messaging-module.md) | Messenger module. **Phase A complete** (schema/registry/permissions). Phases B+ not started. Separate channel from WhatsApp |
