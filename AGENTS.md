...
| Document | Purpose |
|---|---|
| [`docs/whatsapp-messaging-module.md`](whatsapp-messaging-module.md) | WhatsApp module. Manual Cloud API **complete**. Embedded Signup **Phases A–E code-complete** (API Only + Coexistence); **real-number E2E postponed**. Orders postponed — see §21 |
| [`docs/messenger-messaging-module.md`](messenger-messaging-module.md) | Messenger module. **Phases A–G code-complete** — manual path **staging E2E passed**; Phase G Facebook Login staging E2E pending. Separate channel from WhatsApp |
