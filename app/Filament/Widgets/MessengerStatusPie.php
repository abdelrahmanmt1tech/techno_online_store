...
class MessengerStatusPie extends ChartWidget
{
    ...
    {
        return __('dashboard.widget.messenger_status');
    }

    protected function getData(): array
    {
        $data = MessengerPageRegistry::selectRaw('status, COUNT(*) as count')
            ->groupBy('status')
            ->pluck('count', 'status')
            ->toArray();
        ...
        return [
            'datasets' => [
                [
                    'label' => __('dashboard.widget.messenger_pages'),
