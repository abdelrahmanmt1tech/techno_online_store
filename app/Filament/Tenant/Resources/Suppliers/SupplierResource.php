...
class SupplierResource extends Resource
{
    ...
    {
        return tenant_module_any_enabled(\App\Support\Modules\TenantModule::Pos, \App\Support\Modules\TenantModule::Crm) && (Auth::user()->can('erp.suppliers.view'));
    }

    public static function canCreate(): bool
    {
        return Auth::user()->can('erp.suppliers.manage');
    }
