...
class StockReceiptResource extends Resource
{
    ...
    {
        return tenant_module_any_enabled(\App\Support\Modules\TenantModule::Store, \App\Support\Modules\TenantModule::Pos) && (Auth::user()->can('erp.stock_receipts.view'));
    }

    public static function canCreate(): bool
    {
        return Auth::user()->can('erp.stock_receipts.manage');
    }
    ...
    {
        return StockTransactionsTable::configure($table, showTypeFilter: false, permissionKey: 'erp.stock_receipts.manage');
    }
