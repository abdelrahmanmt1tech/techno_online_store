...
class StockTransferResource extends Resource
{
    ...
    {
        return tenant_module_enabled(\App\Support\Modules\TenantModule::Pos) && (Auth::user()->can('erp.stock_transfers.view'));
    }

    public static function canCreate(): bool
    {
        return Auth::user()->can('erp.stock_transfers.manage');
    }
    ...
    {
        return StockTransactionsTable::configure($table, showTypeFilter: false, permissionKey: 'erp.stock_transfers.manage');
    }
